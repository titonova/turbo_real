...
//> Functions interpreter-constructor
  ...
  Interpreter() {
	...
	* 	abs(mixed $number)
	*	Rounds off a number
	*	@param $number The numbet to be rounded off
	*	From PHP
	* */
	/*
	globals.define("abs",new LoxCallable(){
		...
		public Object call(Interpreter interpreter,
	   		...
	   		return java.lang.Math.abs(arguments.get(0));
		}
		@Override
...
//	 System.out.println(arguments.get(0).toString());
	...
	* */
	...
	globals.define("ceil",new LoxCallable(){
		...
		public Object call(Interpreter interpreter,
	   		...
	   		return java.lang.Math.ceil((double) arguments.get(0));
		}
		@Override
		public String toString() { return "<native fn>";}
	});
    ...
    * */
	...
	//STRLEN-UNFINISHED
	globals.define("strlen", new LoxCallable() {
	@Override
	public int arity() { return 1; }
    ...
    UNFINISHED!!!
    trim()**/
    globals.define("trim", new LoxCallable() {
      @Override
      public int arity() { return 1; }
